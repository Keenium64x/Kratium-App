        ...
        <div className='flex items-center gap-4'>
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon">
                <Sun className="h-[1.rem] w-[1.2rem] scale-100 rotate-0 transition-all dark:scale-0 dark:-rotate-90" />
                <Moon className=" h-[1.rem]  w-[1.2rem] scale-0 rotate-90 transition-all dark:scale-100 dark:rotate-0" />
